        ...
        <div class="item-box layui-clear" id="list-cont">
          ...
          <div class="item">
            ...
            <div class="text">
              ...
              <p class="info-cont">优雅的外观、强劲的动力、与生俱来的运动性能与前端的造车技艺为奥迪RS7 Sportback Performance打造独树一帜的王者风范，使其成就集万千优势于一体的艺术之躯。当你打开车门，客舱上乘的材质、考究的工艺都在告诉你：这一切将专属于你。而专属王者的极速之美，在这个风云际会的时代，已强势来袭。</p>
            </div>
          </div>
