    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'particularsId', title: 'ID', width: 80, fixed: 'left', unresize: true, sort: true}
                , {field: 'name', title: '用户名', width: 100, edit: 'text'}
                , {field: 'tel', title: '密码', width: 120, edit: 'text'}
                , {field: 'email', title: '姓名', width: 80, edit: 'text'}
                , {field: 'salesmanUser', title: '电话', width: 200}
                , {field: 'salesmanPass', title: '地区', width: 100}
                , {field: 'level', title: '电话', width: 200}
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                layer.confirm('真的删除行么'+data.particularsId, function (index) {
                    obj.del();
                    layer.close(index);
                    $.ajax({
                        url: "/salesman/delall?particularsid="+data.particularsId,
                        method: 'post',
                        success: function (data) {
                        }
                    })
