...
<!-- bootstrap-css -->
<link rel="stylesheet" href="ceshi/css/bootstrap.css">
<!-- //bootstrap-css -->
<!-- Custom CSS -->
<link href="ceshi/css/style.css" rel='stylesheet' type='text/css' />

<link rel="stylesheet" href="ceshi/css/font.css" type="text/css"/>
<link href="ceshi/css/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome icons -->
<script>
        (function () {
          var js;
          if (typeof JSON !== 'undefined' && 'querySelector' in document && 'addEventListener' in window) {
            js = 'ceshi/js/jquery.min.js';
          } else {
            js = 'ceshi/js/jquery.min.js';
          }
...
<script src="ceshi/js/modernizr.js"></script>
<script src="ceshi/js/jquery.cookie.js"></script>
<script src="ceshi/js/screenfull.js"></script>
		<script>
		$(function () {
...
<!-- charts -->
<script src="ceshi/js/raphael-min.js"></script>
<script src="ceshi/js/morris.js"></script>
<link rel="stylesheet" href="ceshi/css/morris.css">
<!-- //charts -->
<!--skycons-icons-->
<script src="ceshi/js/skycons.js"></script>
<!--//skycons-icons-->
</head>
	...
	<section class="wrapper scrollable">
		...
		<div class="main-grid">
			...
			<div class="social grid">
					<div class="grid-info">
						<div class="col-md-2 top-comment-grid">
		...
		<!-- footer -->
		<div class="footer">
			<p>Copyright &copy; 2019.Company name All rights reserved.More Templates - 测试页面</p>
		</div>
		<!-- //footer -->
	</section>
	<script src="ceshi/js/bootstrap.js"></script>
	<script src="ceshi/js/proton.js"></script>
