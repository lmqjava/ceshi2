  ...
  <div class="header">
    <div class="headerLayout w1200">
      <div class="headerCon">
        <h1 class="mallLogo">
          <a href="#" title="母婴商城">
            <img src="../res/static/img/logo2.png"  width="250" height="80">
          </a>
        </h1>
    ...
    <div class="data-cont-wrap w1200">
      ...
      <div class="product-intro layui-clear">
        <div class="preview-wrap">
          <a href="javascript:;"><img src="../res/static/img/11111.png" height="400" width="400"></a>
        </div>
        <div class="itemInfo-wrap">
          <div class="itemInfo">
            <div class="title">
              <h4>2019限量款赌圣亲传超级跑车 </h4>
              <span><i class="layui-icon layui-icon-rate-solid"></i>收藏</span>
            </div>
            <div class="summary">
              <p class="reference"><span>参考价</span> <del>￥280000000.00</del></p>
            ...
            <div class="choose-attrs">
              <div class="color layui-clear"><span class="title">颜&nbsp;&nbsp;&nbsp;&nbsp;色</span> <div class="color-cont"><span class="btn">白色</span> <span class="btn active">黄色</span></div></div>
      ...
      <div class="layui-clear">
        <div class="aside">
          ...
          <div class="item-list">
            <div class="item">
              <img src="../res/static/img/22222.png" height="280" width="280">
              <p><span>兰</span><span class="pric">￥99.00</span></p>
            </div>
            <div class="item">
              <img src="../res/static/img/22222.png" height="280" width="280">
              <p><span>兰博基尼</span><span class="pric">￥99.00</span></p>
            </div>
            <div class="item">
              <img src="../res/static/img/22222.png" height="280" width="280">
              <p><span>兰博基尼</span><span class="pric">￥99.00</span></p>
        ...
        <div class="detail">
          <h4>详情</h4>
          <div class="item">
            <img src="../res/static/img/22222.png" height="2402" width="800">
          </div>
        </div>
      </div>
    </div>
