      ...
      <div class="headerCon">
        ...
        <div class="mallSearch">
          <form action="" class="layui-form" novalidate>
            <input type="text" name="title" required  lay-verify="required" autocomplete="off" class="layui-input" placeholder="排量，品牌，系列">
  ...
  <div class="footer">
    ...
    <div class="mod_help w1200">                                     
      <p>
        ...
        <span>|</span>
        <a href="javascript:;">新车资讯</a>
        <span>|</span>
        <a href="javascript:;">关于货源</a>
      </p>
      <p class="coty">二手车版权所有 &copy; 2012-2020</p>
    </div>
  </div>
  ...
  <script type="text/javascript">
    layui.config({
        ...
        var vUrl = $('#video').data('url'),
            ...
            autoplay: true,
            video: [
                [vUrl, 'https://www.yunbtv.com/play/44261-0-0.html']
            ]
        };
